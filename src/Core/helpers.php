...
{
    // Convert $value to a string if it is null or not a string
    $value = is_null($value) ? '' : (string) $value;
    
    // Use htmlspecialchars with the provided options
    return htmlspecialchars($value, ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401, 'UTF-8', $doubleEncode);
}
}
